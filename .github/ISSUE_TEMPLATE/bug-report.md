---
name: Bug Report
about: Create a report to help us improve gramr
...
* Check the [releases](https://github.com/lantah/gramr/releases) page to see if your issue has been fixed in a later release.
...
### GramR Version
* If using a standard release, please add the version returned by `./gramr --version`
